...
INSERT INTO arrende_arrendekontraktsrader (arrendekontrakt, arrendeartikel, avitext,
                                                            ...
                                                            index_nuvarande_varde, radnummer, id)
...
--------------------------------
INSERT INTO fastighetsbas_fastighet (hyresid,foretag,foretagsnamn,fastighetsnr,fastighetsbeteckning,kommun,trakt,block,fangesdatum,agarforhallande,agare,agarenamn,postadress,postadress2,postnummer,ort,land,tomtratt,tomtratt_dodad_datum,fran_datum,till_datum,en_forvaltningsenhet_kopplad,id) VALUES
...
--------------------------------
INSERT INTO arrende_arrendeartikel (arrendeartikel,artikelbenamning,avitext,artikelgrupp,artikeltyp,reglering,pris,ingar_i_kontraktssumma,avdrag,debiteras_alltid_hel_period,avvikelsetolerans_procent,summarad,aktiv,id) VALUES
...
--------------------------------
-- Testdata for kundreskontra_kund
--------------------------------
INSERT INTO kundreskontra_kund (person_org_nr,kontaktid,kategori,namn,fornamn,efternamn,avdelning,postadress,postadress2,postnummer,ort,land,telefon_mobil,telefon_hem,telefon_arbete,e_post,foredraget_kontaktsatt,svefaktura,efakturaadress,forvaltartyp,god_man_forvaltare,aktiv,id) VALUES
	 ('191010101010','TEST','Person','ANKA KALLE','KALLE','ANKA','','VÄGEN 16','','12345','ANKEBORG','SVERIGE','','','','','Ej angivet','Nej','','','','Ja',''),
	 ('199010101010','TEST','Person','VON ANKA JOAKIM','VON ANKA','JOAKIM','','GATAN 103','','89101','ANKEBORG','SVERIGE','','','','','Ej angivet','Nej','','','','Ja','');

--------------------------------
-- Testdata for gemensamt_notering
--------------------------------
INSERT INTO gemensamt_notering (noteringsnamn,prioritet,typ,folder,objektid,objektid2,foretag,forvaltningsenhet,fastighetsnr,byggnad,arrendeobjekt,byggnadsdel,markyta,`system`,uppgang_vaning,bilplats,lokal,bostad,underhallsenhet,ovrigt_hyresobjekt,rum,komponent,noteringsid,filnamn,id) VALUES
