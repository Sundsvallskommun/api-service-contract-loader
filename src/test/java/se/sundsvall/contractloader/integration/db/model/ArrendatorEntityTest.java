...
class ArrendatorEntityTest {
	...
	void testBuilderMethods() {
		...
		final var id1 = "id1";
		final var kundEntities = List.of(new KundEntity());
		...
		assertThat(arrendatorEntity.getKundEntities()).hasSize(1).containsExactly(kundEntities.getFirst());
	}
